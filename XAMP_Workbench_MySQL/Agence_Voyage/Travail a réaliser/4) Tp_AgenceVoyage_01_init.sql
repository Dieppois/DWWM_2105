...
CREATE TABLE COMMERCIAUX(
   ...
   com_code_1 CHAR(5), FOREIGN KEY(com_code_1) REFERENCES COMMERCIAUX(com_code)
);
...
DROP FOREIGN KEY commerciaux_ibfk_1;

ALTER TABLE COMMERCIAUX
DROP COLUMN com_code__1;

ALTER TABLE COMMERCIAUX
ADD com_code_1 CHAR(5);

ALTER TABLE COMMERCIAUX
ADD CONSTRAINT FK_com_code_1 FOREIGN KEY(com_code_1) REFERENCES COMMERCIAUX(com_code);
   
ALTER TABLE CLIENTS
ADD COLUMN com_code VARCHAR(5) NULL;

ALTER TABLE CLIENTS
DROP COLUMN com_code;

ALTER TABLE CLIENTS
ADD COLUMN client_password CHAR(60) NOT NULL;

ALTER TABLE CLIENTS
DROP FOREIGN KEY e;

ALTER TABLE CLIENTS
ADD CONSTRAINT fk_com_code FOREIGN KEY (com_code) REFERENCES COMMERCIAUX (com_code);
