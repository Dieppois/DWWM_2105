...
namespace ConsoleAppTestMajorite
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            if (dateAnniv.CompareTo(jourMaj) == -1) Console.WriteLine("\nVous êtes majeur");

            else if (dateAnniv.CompareTo(jourMaj) == 0) Console.WriteLine("\nVous êtPes tout juste majeur, bon anniversaire !! ");
